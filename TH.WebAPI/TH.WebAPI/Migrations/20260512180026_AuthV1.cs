        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 113, "tai_san.reject", "tai_san.reject", "TaiSanReject", "staff" },
                    { 114, "tai_san.update", "tai_san.update", "TaiSanUpdate", "staff" },
                    { 115, "thanh_ly_tai_san.create", "thanh_ly_tai_san.create", "ThanhLyTaiSanCreate", "staff" },
                    { 116, "thanh_ly_tai_san.delete", "thanh_ly_tai_san.delete", "ThanhLyTaiSanDelete", "staff" },
                    { 117, "thanh_ly_tai_san.get_all", "thanh_ly_tai_san.get_all", "ThanhLyTaiSanGetAll", "staff" },
                    { 118, "thanh_ly_tai_san.get_by_asset", "thanh_ly_tai_san.get_by_asset", "ThanhLyTaiSanGetByAsset", "staff" },
                    { 119, "thanh_ly_tai_san.get_by_id", "thanh_ly_tai_san.get_by_id", "ThanhLyTaiSanGetById", "staff" },
                    { 120, "thanh_ly_tai_san.update", "thanh_ly_tai_san.update", "ThanhLyTaiSanUpdate", "staff" },
                    { 121, "user.admin_get_all", "user.admin_get_all", "UserAdminGetAll", "staff" },
                    { 122, "user.admin_get_by_id", "user.admin_get_by_id", "UserAdminGetById", "staff" },
                    { 123, "user.admin_get_slim_by_id", "user.admin_get_slim_by_id", "UserAdminGetSlimById", "staff" },
                    { 124, "user.delete", "user.delete", "UserDelete", "staff" },
                    { 125, "user.get_all", "user.get_all", "UserGetAll", "staff" },
                    { 126, "user.get_all_slim", "user.get_all_slim", "UserGetAllSlim", "staff" },
                    { 127, "user.get_by_department_id", "user.get_by_department_id", "UserGetByDepartmentId", "staff" },
                    { 128, "user.get_me", "user.get_me", "UserGetMe", "staff" },
                    { 129, "user.get_slim_by_id", "user.get_slim_by_id", "UserGetSlimById", "staff" },
                    { 130, "user_role.admin_assign", "user_role.admin_assign", "UserRoleAdminAssign", "staff" },
                    { 131, "user_role.assign", "user_role.assign", "UserRoleAssign", "staff" },
                    { 132, "user_session.get_all", "user_session.get_all", "UserSessionGetAll", "staff" },
                    { 133, "user_session.get_by_session_id", "user_session.get_by_session_id", "UserSessionGetBySessionId", "staff" },
                    { 134, "user_session.get_by_user_id", "user_session.get_by_user_id", "UserSessionGetByUserId", "staff" },
                    { 135, "user.update_profile", "user.update_profile", "UserUpdateProfile", "staff" },
                    { 136, "user.update_username", "user.update_username", "UserUpdateUsername", "staff" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 8, 5, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc) },
