...
import { Plus, Search, Edit, Trash2, X, Save, BookOpen } from 'lucide-react';
        ...
        <table className="w-full">
          ...
          <tbody className="divide-y divide-gray-200">
            {isLoading ? (
              ...
              <tr><td colSpan={5} className="text-center py-8 text-gray-500">Chưa có tài khoản nào.</td></tr>
            ) : (
                ...
                <tr key={acc.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-center">
                    <div className="flex items-center justify-center gap-2">
                      <button onClick={() => openModal(acc)} className="p-1 text-orange-600 hover:bg-orange-50 rounded" title="Sửa">
                        <Edit className="w-4 h-4" />
                      </button>
                      <button onClick={() => acc.id && handleDelete(acc.id)} className="p-1 text-red-600 hover:bg-red-50 rounded" title="Xóa">
          ...
          <div className="bg-white rounded-lg max-w-md w-full shadow-2xl flex flex-col overflow-hidden">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              <div className="pt-4 flex justify-end gap-3 border-t mt-6">
                <button type="button" onClick={closeModal} className="px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-100 text-gray-700">
                  Hủy
                </button>
